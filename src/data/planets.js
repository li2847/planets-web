...
<div class="story-container">
  ...
  <p class="sc-risk"><span class="sc-risk-label">风险：</span><span class="sc-risk-desc">以人类现有技术<span class="sc-hl">几乎无法抵达</span>，即使以光速航行也需要 1400 年。当你抵达时，宿主恒星已进入演化晚期，光度持续升高，宜居带正在向外推移，这颗「地球表哥」<span class="sc-hl">可能已变成一片干旱的荒原</span>。</span></p>
        ...
        narrative: {
            floatTitle: "翡翠色的交响森林",
            ch1Label: "降 落",
            ch1: "舱门开启，满眼都是翡翠色山峦，山体被茂密森林覆盖，林间有青绿色缓坡，坡上长满绒状青苔藓，山涧流淌着澄澈的淡绿色溪水。",
            ch2Label: "初 见",
            ch2: "你走进森林，听见轻柔的蹄声，循声发现一只鹿。它通体呈浅棕色，身头顶长着对称的短角，正低头轻嗅着地面的青草。",
            ch3Label: "相 依",
            ch3: "小鹿不慎从缓坡滑落，恰好跌在你身前，身体微微颤抖。你取出医疗胶小心翼翼为它处理蹄尖伤口，它温顺地蹭着你的指尖，全程没有挣扎，眼神里满是依赖。",
            ch4Label: "共 生",
            ch4: "伤口愈合后，灵鹿停在你身侧，你带着它走到山涧边。小鹿围着花丛跳跃轻嗅，你坐在青苔藓坡上看着它，心中满是惆怅，这般安稳，就这样一直下去也不错。",
        },
        narrativeL3: {
            ...L3_CHAPTER_LABELS,
...
<div class="story-container">
  ...
  <p class="sc-risk"><span class="sc-risk-label">风险：</span><span class="sc-risk-desc">距离适中，是<span class="sc-hl">较有希望抵达</span>的海洋行星之一。当你抵达时，行星正处于极光风暴的活跃期，海面风浪极大，浮岛设施极易受损，着陆平台的稳定性<span class="sc-hl">面临严峻考验</span>。</span></p>
        ...
        narrative: {
            ...
            ch2Label: "初 见",
            ch2: "你在浮岛边缘漫步，靠近礁石山时，发现了一只狐狸，一身顺滑的棕红皮毛，拖着蓬松长尾。它正蹲在礁石旁舔食发光海苔。",
            ch3Label: "相 依",
            ch3: "极光风岚骤然袭来，你急忙抱起狐狸，躲进浮岛边缘的类海藻避风棚，它安静地蜷缩在你怀里传递暖意。",
            ch4Label: "共 生",
            ch4: "风暴平息，极光依旧温柔，海面泛着荧光。你带着暖核狐在浮岛漫步，它在类海藻上奔跑戏水，你看着它，心中生出惆怅，这样相依相伴，一直下去就好。",
        },
        narrativeL3: {
            ...L3_CHAPTER_LABELS,
            ch1: "平台边缘检测到极高热能残留。狐狸原本停留的地方只留下一圈深褐色的灼痕以及几根碳化的毛发。",
...
<div class="story-container">
  ...
  <p class="sc-risk"><span class="sc-risk-label">风险：</span><span class="sc-risk-desc">理论上是<span class="sc-hl">最容易抵达</span>的系外行星之一，但以当前技术，即使借助激光帆推进，也需要数千年航行。抵达时，行星正可能处于母星耀斑活动的高峰期，<span class="sc-hl">辐射环境极不稳定</span>。</span></p>
        ...
        narrative: {
            floatTitle: "琥珀色的永恒午后",
            ch1Label: "降 落",
            ch1: "舱门开启，目之所及皆是连绵的琥珀色矮山，山体由红色砂岩构成，山脚下蜿蜒着窄细的淡琥珀色溪流。",
            ch2Label: "初 见",
            ch2: "沿着溪流前行，你在矮山背阴处，偶然看见一只兔子。它通体雪白，耳朵轻轻耷拉着，正低头舔饮溪水。",
            ch3Label: "相 依",
            ch3: "这里的重力略大于地球，你攀过矮山坡时渐渐乏力，不小心踩滑，那只小兔子立刻用脑袋轻轻蹭你的裤腿，引你站稳身形。",
            ch4Label: "共 生",
